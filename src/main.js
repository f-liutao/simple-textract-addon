...
function main(folderId) {
    ...
    const namedRange = (_a = sheetService.named_range) !== null && _a !== void 0 ? _a : sheetService.initialize();
    const today = Utilities.formatDate(new Date(), new User().timezone, "yyyyMMdd-HHmm");
